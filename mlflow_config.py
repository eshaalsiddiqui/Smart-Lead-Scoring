...
class MLflowManager:
    ...
    def log_model_performance(self, run_id: str, model_name: str, metrics: dict, 
    ...
    def compare_models(self, model_name: str, metric_name: str = "auc_score", 
                      limit: int = 10):
        """
    ...
    def create_model_deployment(self, model_name: str, version: str = None, 
